...
export const getAllUsersController = async (req, res) => {
  try {
    ...
    res.status(500).send({
      success: false,
      message: "Error WHile Geting Allusers",
      error,
    });
  }
};
...
export const getWishlistController = async (req, res) => {
  try {
    ...
    res.status(500).send({
      success: false,
      message: "Error WHile Geting wishlist",
      error,
    });
  }
};
...
export const getSingleWishlistController = async (req, res) => {
  try {
    ...
    const result = await checkProductInWishlist(userId, prodId);
...
export const checkProductInWishlist = async (userId, prodId) => {
  try {
    ...
    // console.log(isProductInWishlist + " wishlist");
